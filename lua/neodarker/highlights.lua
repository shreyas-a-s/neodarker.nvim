...
M.highlights = {
    ...
    MoreMsg = { fg = p.blue },
    IncSearch = { fg = 'NONE', bg = "#194765" },
    Search = { fg = 'NONE', bg = '#63341d' },
    CurSearch = { fg = 'NONE', bg = '#6b5c46' },
    ...
    markdownH1 = {   bold = true,   fg = "#bb9af7"   },
    markdownH2 = {   bold = true,   fg = "#7aa2f7"   },
    ...
    ["@markup.heading.1.markdown"] = { bold = true, fg = "#7aa2f7" },
    ["@markup.heading.2.markdown"] = { bold = true, fg = "#e0af68" },
    ["@markup.heading.3.markdown"] = { bold = true, fg = "#9ece6a" },
    ["@markup.heading.4.markdown"] = { bold = true, fg = "#1abc9c" },
    ["@markup.heading.5.markdown"] = { bold = true, fg = "#bb9af7" },
    ["@markup.heading.6.markdown"] = { bold = true, fg = "#9d7cd8" },
