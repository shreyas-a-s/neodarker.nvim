...
M.highlights = {
    ...
    markdownH1 = { fg = "#bb9af7"   },
    markdownH2 = { fg = "#7aa2f7"   },
    ...
    ["@markup.heading.1.markdown"] = { fg = "#7aa2f7" },
    ["@markup.heading.2.markdown"] = { fg = "#e0af68" },
    ["@markup.heading.3.markdown"] = { fg = "#9ece6a" },
    ["@markup.heading.4.markdown"] = { fg = "#1abc9c" },
    ["@markup.heading.5.markdown"] = { fg = "#bb9af7" },
    ["@markup.heading.6.markdown"] = { fg = "#9d7cd8" },
